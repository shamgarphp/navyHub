        ...
        <div class="portlet light bordered">
          <div class="portlet-title">
            ...
            <div class="btn-group" style="float: right;">
               <a class="pull-right btn btn-warning btn-large" style="margin-right:40px" href="<?php echo site_url(); ?>/navy/submarine/weatherStationexcel"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
            </div>
          </div>
